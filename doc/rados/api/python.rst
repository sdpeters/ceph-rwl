...
To install Python libraries for Ceph on Ubuntu, execute the following:: 

	sudo apt-get install python-ceph
	
To install Python libraries for Ceph on RHEL/CentOS, execute the following:: 

	sudo yum install python-ceph
	
.. tip:: Ensure that the ``python-ceph`` library is the same 
   version as your Ceph Storage Cluster.

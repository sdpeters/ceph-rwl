...
TEST_F(TestWriteLogMap, OverlapFront) {
  ...
  auto e0 = make_shared<WriteLogEntry>(BlockToBytes(4), BlockToBytes(8));
  map.add_log_entry(e0);
  /* replaces block 4-7 of e0 */
  auto e1 = make_shared<WriteLogEntry>(BlockToBytes(0), BlockToBytes(8));
  map.add_log_entry(e1);
...
TEST_F(TestWriteLogMap, OverlapBack) {
  ...
  auto e0 = make_shared<WriteLogEntry>(BlockToBytes(0), BlockToBytes(8));
  map.add_log_entry(e0);
  /* replaces block 4-7 of e0 */
  auto e1 = make_shared<WriteLogEntry>(BlockToBytes(4), BlockToBytes(8));
  map.add_log_entry(e1);
...
TEST_F(TestWriteLogMap, OverlapMiddle) {
  ...
  auto e0 = make_shared<WriteLogEntry>(BlockToBytes(0), BlockToBytes(1));
  map.add_log_entry(e0);
  ...
  auto e1 = make_shared<WriteLogEntry>(BlockToBytes(1), BlockToBytes(1));
  map.add_log_entry(e1);
  ...
  auto e2 = make_shared<WriteLogEntry>(BlockToBytes(2), BlockToBytes(1));
  ...
  /* replaces e1 */
  auto e3 = make_shared<WriteLogEntry>(BlockToBytes(1), BlockToBytes(1));
...
TEST_F(TestWriteLogMap, OverlapSplit) {
  ...
  auto e2 = make_shared<WriteLogEntry>(BlockToBytes(4), BlockToBytes(2));
  map.add_log_entry(e2);

  /* Replaces one block of e2, and one of e0 */
  auto e3 = make_shared<WriteLogEntry>(BlockToBytes(5), BlockToBytes(2));
  map.add_log_entry(e3);

...
public:
  ...
  struct Op : public RefCountedObject {
    ...
    Op(const object_t& o, const object_locator_t& ol, vector<OSDOp>& op,
       int f, Context *ac, Context *co, version_t *ov, Objecter *ob) :
...
public:
  ...
  Op *prepare_mutate_op(const object_t& oid, const object_locator_t& oloc, 
    ...
    Op *o = new Op(oid, oloc, op.ops, flags | global_op_flags | CEPH_OSD_FLAG_WRITE, onack, oncommit, objver, this);
  ...
  Op *prepare_read_op(const object_t& oid, const object_locator_t& oloc,
    ...
    Op *o = new Op(oid, oloc, op.ops, flags | global_op_flags | CEPH_OSD_FLAG_READ, onack, NULL, objver, this);
    o->priority = op.priority;
    o->snapid = snapid;
    o->outbl = pbl;
  ...
  tid_t stat(const object_t& oid, const object_locator_t& oloc, snapid_t snap,
    ...
    Op *o = new Op(oid, oloc, ops, flags | global_op_flags | CEPH_OSD_FLAG_READ, fin, 0, objver, this);
    o->snapid = snap;
    o->outbl = &fin->bl;
    return op_submit(o);
  }
  ...
  tid_t read(const object_t& oid, const object_locator_t& oloc, 
    ...
    Op *o = new Op(oid, oloc, ops, flags | global_op_flags | CEPH_OSD_FLAG_READ, onfinish, 0, objver, this);
    o->snapid = snap;
    o->outbl = pbl;
    return op_submit(o);
  }
  ...
  tid_t _modify(const object_t& oid, const object_locator_t& oloc,
    ...
    Op *o = new Op(oid, oloc, ops, flags | global_op_flags | CEPH_OSD_FLAG_WRITE, onack, oncommit, objver, this);
    o->mtime = mtime;
    o->snapc = snapc;
    return op_submit(o);
  }
  ...
  tid_t rollback_object(const object_t& oid, const object_locator_t& oloc,
    ...
    Op *o = new Op(oid, oloc, ops, CEPH_OSD_FLAG_WRITE, onack, oncommit, objver, this);
    o->mtime = mtime;
    o->snapc = snapc;
    return op_submit(o);
  }
  tid_t create(const object_t& oid, const object_locator_t& oloc, 
    ...
    Op *o = new Op(oid, oloc, ops, global_flags | global_op_flags | CEPH_OSD_FLAG_WRITE, onack, oncommit, objver, this);
    o->mtime = mtime;
    o->snapc = snapc;
    return op_submit(o);
  }

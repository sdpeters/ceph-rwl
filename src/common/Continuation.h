 ...
 * stage, call get_callback(stage_number).
 *
 * To use a class:
 ...
 * is completed while any other stages are in flight. It's best to be serial
 * unless you want to maintain your own metadata about which stages are still
 * pending.
 */
